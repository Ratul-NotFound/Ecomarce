      ...
      <form onSubmit={handlePlaceOrder} className="checkout-stream-layout">
        ...
        <div className="checkout-card">
          <div className="checkout-card-header">
            ...
            <h2 className="checkout-card-title">1. Delivery Address / ডেলিভারি ঠিকানা</h2>
          </div>
          ...
          {appliedCoupon ? (
            ...
            <div>
              ...
              <div style={{ fontSize: '11px', color: 'var(--color-text-muted)', marginTop: '8px' }}>
                💡 Apply discount voucher before reviewing total amount and payment.
              </div>
            </div>
          )}
        </div>
        ...
        <div className="checkout-card">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', borderTop: '1px solid var(--color-border)', paddingTop: '16px', fontSize: '14px', color: 'var(--color-text-secondary)' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
              <span>Delivery Fee / ডেলিভারি চার্জ ({district})</span>
            ...
            {discountAmount > 0 && (
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', color: 'var(--color-danger)' }}>
                <span>Coupon Discount (কুপন ডিসকাউন্ট)</span>
                <span>-{formatCurrency(discountAmount)}</span>
              </div>
            )}

            {/* Grand Total Highlight */}
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderTop: '2px dashed var(--color-border)', paddingTop: '14px', marginTop: '4px' }}>
              <div>
                <span style={{ fontSize: '16px', fontWeight: 800, color: 'var(--color-text-primary)' }}>Total Payable / সর্বমোট প্রদেয়</span>
                <div style={{ fontSize: '11px', color: 'var(--color-text-muted)' }}>সব মিলিয়ে মোট টাকা</div>
              </div>
        ...
        <div className="checkout-card">
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '16px', flexWrap: 'wrap', gap: '8px' }}>
            <div className="checkout-card-header" style={{ marginBottom: 0 }}>
              ...
              <h2 className="checkout-card-title">4. Payment Method / পেমেন্ট পদ্ধতি</h2>
            </div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '14px' }}>
            ...
            {paymentSettings.cod.enabled && (
              <div
                ...
                className={`checkout-payment-option ${paymentMethod === 'cod' ? 'checkout-payment-option--cod-active' : ''}`}
              >
            ...
            {paymentSettings.bkash.enabled && (() => {
              ...
              return (
                <div
                  ...
                  className={`checkout-payment-option ${isSelected ? 'checkout-payment-option--bkash-active' : ''}`}
                >
                  <div className="checkout-payment-header">
                    <input
                      type="radio"
                      ...
                      style={{ width: '18px', height: '18px', accentColor: '#e2136e', cursor: 'pointer', flexShrink: 0 }}
                    />
                    <BkashLogo size={42} />
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '6px', flexWrap: 'wrap' }}>
            ...
            {paymentSettings.nagad.enabled && (() => {
              ...
              return (
                <div
                  ...
                  className={`checkout-payment-option ${isSelected ? 'checkout-payment-option--nagad-active' : ''}`}
                >
                  <div className="checkout-payment-header">
                    <input
                      type="radio"
                      ...
                      style={{ width: '18px', height: '18px', accentColor: '#f97316', cursor: 'pointer', flexShrink: 0 }}
                    />
                    <NagadLogo size={42} />
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: '6px', flexWrap: 'wrap' }}>
        ...
        {/* Final Submit Action & Security Guarantee */}
        <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
          ...
          >
            <span>{isSubmitting ? 'Placing Order...' : `Place Order • ${formatCurrency(grandTotal)}`}</span>
            <ArrowRight size={20} />
          </button>

          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px', fontSize: '12px', color: 'var(--color-text-muted)' }}>
            <ShieldCheck size={16} color="var(--color-success)" />
            <span>100% Verified SSL / End-to-End Secure Transaction</span>
          </div>
        </div>
      </form>
    </div>
